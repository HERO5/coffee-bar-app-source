...
//    private void initImgFromUrl(String[] imagesUrl) {
...
////            iv.setBackgroundResource(R.drawable.loading);
//            if (i == 0) {
//                ImageLoader.getInstance().displayImage(imagesUrl[count-1], iv, userImageOptions);
//            } else if (i == count + 1) {
//                ImageLoader.getInstance().displayImage(imagesUrl[0], iv, userImageOptions);
//            } else {
//                ImageLoader.getInstance().displayImage(imagesUrl[i-1], iv, userImageOptions);
//            }
//            imageViews.add(iv);
//        }
//    }
