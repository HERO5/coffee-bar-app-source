...
public class CloseWareRectWithHorizontalTop extends View {
    ...
    public CloseWareRectWithHorizontalTop(Context context) {
        super(context);
    }
    public CloseWareRectWithHorizontalTop(Context context,List<Point> points,int color,int shapeHeight,boolean withBorder){
        super(context);
        this.points = points;
        this.color = color;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Point mControlLeft2 = new Point(3*screenWidth/16,140);
        Point mFirst = new Point(screenWidth/4,70);
        Point mControlFirst = new Point(5*screenWidth/16,0);
        Point mSecond = new Point(3*screenWidth/8,70);
        Point mControlSecond = new Point(7*screenWidth/16,140);
        Point mLeft12 = new Point(screenWidth/2,70);
        Point mControlLeft12 = new Point(9*screenWidth/16,0);
        ...
        Point mControlFirst2 = new Point(13*screenWidth/16,0);
        Point mSecond2 = new Point(7*screenWidth/8,70);
        Point mControlSecond2 = new Point(15*screenWidth/16,140);
